      ...
      body: Consumer<AppModel>(
        builder: (context, appModel, child) {
          if (appModel.user == null || !appModel.user.isValid) {
            return super.notAuthView(appModel.authService);
          } else {
            return TabletAwareLayoutBuilder(
              mobileView: (_) => _authMobileView(
                  appModel.appInfo, appModel.authService, appModel.user),
              tabletView: (_) => _authTabletView(
                  appModel.appInfo, appModel.authService, appModel.user),
            );
          }
        },
