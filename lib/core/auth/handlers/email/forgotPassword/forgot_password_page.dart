    ...
    return PlatformScaffold(
      ...
      body: Material(
        ...
        child: Consumer<AppModel>(
          // TODO figure out if Provider.Consumer is able to / needs to disable rebuilding
          // rebuildOnChange: false,
          builder: (_, appModel, child) => Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
            child: _asForm(_buildForm(appModel.authService)),
          ),
        ),
      ),
    );
