    ...
    return PlatformScaffold(
      ...
      body: Material(
        ...
        child: Consumer<AppModel>(
          builder: (_, appModel, child) => TabletAwareLayoutBuilder(
            mobileView: (_) => _asForm(
              _buildMobileForm(appModel.appInfo, appModel.authService),
            ),
            tabletView: (_) => _asForm(
              _buildTabletForm(appModel.appInfo, appModel.authService),
            ),
          ),
        ),
      ),
